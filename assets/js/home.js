...
// Tab navigation with arrows and tab
...
// API fetching data for tab content
const addTabContent = ($currentTabBtn, $currentTabPanel) => {
  ...
  fetchData(
    ...
    function (data) {
      ...
      for (let i = 0; i < 12; i++) {
        const {
          recipe: { image, label: title, totalTime: coockingTime, uri },
        } = data.hits[i];
        //
        ...
        $card.innerHTML = `
          ...
          <div class="card-body">
            <h3 class="title-small">
              <a href="./assets/html/detail.html?recipe=${recipeId}" class="card-link"
                >${title ?? "N/A"}</a
              >
            </h3>
            <div class="meta-wrapper">
              <div class="meta-item">
                ...
                <span class="label-medium">${
                  getTime(coockingTime).time || "<1"
                } ${getTime(coockingTime).timeUnit} </span>
              </div>
              <button
      ...
      $currentTabPanel.innerHTML += `
      <a
      href="./assets/html/recipes.html?mealType=${$currentTabBtn.textContent
        .trim()
        .toLowerCase()}"
  ...
  fetchData(
    ...
    function (data) {
      ...
      <li class="slider-item" data-slider-item>
        <a
          href="./assets/html/recipes.html?cuisineType=${cuisineType[
            index
          ].toLowerCase()}"
